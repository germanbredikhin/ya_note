...
def test_anon_cant_create_note(client, form_data):
    url = reverse('notes:add')
...
def test_not_author_cant_edit_note(not_author_client, note, form_data):
    url = reverse('notes:edit', args=(note.slug,))
...
def test_not_author_cant_delete_note(not_author_client, slug_for_args):
    url = reverse('notes:delete', args=slug_for_args)
